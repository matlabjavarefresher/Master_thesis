...
% actual 1597X1639 images, so I have commented this temporarily. Note
% unit_test for this function won't work as one of the tests checks whether
% boundary is removed or not, you may have to remove that check
