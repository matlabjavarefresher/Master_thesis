...
initial_shapes=65; % 55,65 70 65 27 58 47 40 31 32 32 27 42 41.3
min_overlap=21688; % 2040, 3000 2450 40000 13582 8000 6113 19697 19909 15400 17090 18045 15412 17263
a_mean=24.03; %26 21.4 22 24.25 21.42 28.3
a_var=8.97; %10.5 11.98 11.76 12.3
b_mean=16.21; %28.3 23.83 25.77 18.46
b_var=14.06; %12.7 14.53 14.82
c_mean=26.29; %27 21.64 24.34 21.64 24.67
c_var=17.58; %12.4 15.4 14.35 13.58
% exponent_min=2;
% exponent_max=5;
ellipsoid_fraction=0.7604;%0.2 0.4453 0.4356 0.777 0.8056
yaw_mean=0; 
yaw_var=pi/2;
pitch_mean=0;
pitch_var=pi/2;
...
weight_vector=[3;3;3;3;3;3;4;4;2;2;1]; % 
